...
class HomeWidgetBackgroundWorker(
    ...
    private suspend fun initializeFlutterEngine() {
        ...
        if (callbackHandle == 0L) {
            throw IllegalStateException("No callbackHandle saved. Did you call HomeWidget.registerBackgroundCallback?")
        }
