...
struct Provider: TimelineProvider {
  ...
  func getSnapshot(in context: Context, completion: @escaping (ThemedCounterHomeWidgetEntry) -> Void) {
  ...
  func getTimeline(in context: Context, completion: @escaping (Timeline<Entry>) -> Void) {
    ...
    completion(Timeline(entries: [ThemedCounterHomeWidgetEntry(date: Date(), data: data)], policy: .atEnd))
...
struct ThemedCounterHomeWidgetEntryView: View {
  ...
  var body: some View {
    ...
    .applyContainerBackground((colorScheme == .dark ? Color(red: 0.043137254901960784, green: 0.07058823529411765, blue: 0.12549019607843137, opacity: 1.0) : Color(red: 0.9372549019607843, green: 0.9647058823529412, blue: 1.0, opacity: 1.0)))
  }
}
