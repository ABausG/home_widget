...
class AdaptiveGreetingHomeWidget {
  const AdaptiveGreetingHomeWidget._();
  ...
  static bool _$isThisWidget(HomeWidgetInfo info) {
    ...
    if (androidClassName != null) {
      return androidClassName.endsWith('.AdaptiveGreetingHomeWidgetReceiver');
    }
    return info.iOSKind == 'AdaptiveGreetingHomeWidget';
  }
}
