...
<Info>
This documentation is based on a non configurable Widget. So make sure to not tick the box for <kbd>Include Configuration App Intent</kbd> to keep the syntax the same
